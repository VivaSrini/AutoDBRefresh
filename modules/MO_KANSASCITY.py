# Source Info:
#   {
#     "Provider": "MO_KANSASCITY",
#     "State": "MO",
#     "Name": "City of Kansas City, MO",
#     "Website": "https://kcmohrd.mwdbe.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "KCMO’s Certified Directory",
#     "Download": "Manual",
#     "FileName": "MO_KANSASCITY.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['cert_num'] = prepare_csv_data(row[18])
