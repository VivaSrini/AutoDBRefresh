...
#     "State": "NJ",
#     "Name": "New Jersey UCP",
#     "Website": "https://njucp.dbesystem.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "Search Certified Directory",
#     "Download": "Manual",
#     "FileName": "NJ_UCP.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl5'] = prepare_csv_data(row[19], prefix='County')
