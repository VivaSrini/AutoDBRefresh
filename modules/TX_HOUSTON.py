...
#     "Website": "https://houston.mwdbe.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "City of Houston MWSBE/PDBE, DBE/ACDBE, and LGBTBE Directory",
#     "Download": "Manual",
#     "FileName": "TX_HOUSTON.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl6'] = prepare_csv_data(row[19], prefix='Category')
            dict1['addl7'] = prepare_csv_data(row[20], prefix='HUB?')
