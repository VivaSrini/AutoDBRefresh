# Source Info:
#   {
#     "Provider": "NC_CHARLOTTE",
#     "State": "NC",
#     "Name": "City of Charlotte, NC",
#     "Website": "https://charlotte.diversitycompliance.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": " City of Charlotte Certified Directory",
#     "Download": "Manual",
#     "FileName": "NC_CHARLOTTE.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl6'] = prepare_csv_data(row[18], prefix='Area of Service')
