# Source Info:
#   {
#     "Provider": "TN_NASHVILLE",
#     "State": "TN",
#     "Name": "Metropolitan Nashville Airport Authority",
#     "Website": "https://flynashville.diversitycompliance.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "Certified Vendor Directory",
#     "Download": "Manual",
#     "FileName": "TN_NASHVILLE.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['cert_expiry'] = prepare_csv_data(row[17])
