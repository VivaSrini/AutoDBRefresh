...
#     "Website": "https://cityoforlando.mwdbe.com//FrontEnd/searchcertifieddirectory.asp",
#     "Title": "City of Orlando Certified Directory",
#     "Download": "Manual",
#     "FileName": "FL_ORLANDO.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl5'] = prepare_csv_data(row[19], prefix='Capabilities')
            dict1['addl6'] = prepare_csv_data(row[20], prefix='Services')
            dict1['addl7'] = prepare_csv_data(row[21], prefix='Construction')
            dict1['addl8'] = prepare_csv_data(row[22], prefix='Professionals/Consultants')
            dict1['addl9'] = prepare_csv_data(row[23], prefix='Suppliers')
            dict1['addl9'] = prepare_csv_data(row[24], prefix='Transportation')
