...
#     "Provider": "FL_GOAA",
#     "State": "FL",
#     "Name": "Greater Orlando Aviation Authority",
#     "Website": "https://goaa.diversitycompliance.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "Certified Vendor Directory",
#     "Download": "Manual",
#     "FileName": "FL_GOAA.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            (pnaics, onaics) = get_pnaics_onaics(row[20])
            dict1['pnaics'] = pnaics
            ...
            dict1['addl6'] = prepare_csv_data(row[19], prefix='Firm is LDB or LDB CMAR')
