...
#     "State": "ID",
#     "Name": "Idaho DOT",
#     "Website": "https://itd.dbesystem.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "Certified DBE/ACDBE Directory",
#     "Download": "Manual",
#     "FileName": "ID_DOT.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl6'] = prepare_csv_data(row[19], prefix='Work Districts/Regions')
            dict1['addl7'] = prepare_csv_data(row[20], prefix='Work Category')
