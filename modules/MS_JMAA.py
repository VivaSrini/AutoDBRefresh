...
#     "Provider": "MS_JMAA",
#     "State": "MS",
#     "Name": "Jackson Municipal Airport Authority",
#     "Website": "https://jmaa.dbesystem.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "Jackson Municipal Airport Authority's Certification Directory",
#     "Download": "Manual",
#     "FileName": "MS_JMAA.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl6'] = prepare_csv_data(row[19], prefix='County')
            dict1['addl7'] = prepare_csv_data(row[20], prefix='DBE Type')
            dict1['addl8'] = prepare_csv_data(row[21], prefix='Service Area(s)')
