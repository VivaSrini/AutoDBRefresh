# Source Info:
#   {
#     "Provider": "LA_NEWORLEANS",
#     "State": "LA",
#     "Name": "City of New Orleans, LA",
#     "Website": "https://neworleans.dbesystem.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "DBE Certification Directory",
#     "Download": "Manual",
#     "FileName": "LA_NEWORLEANS.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['cert_agency'] = prepare_csv_data(row[21])
            ...
            dict1['addl5'] = prepare_csv_data(row[18], prefix='Certified')
            dict1['addl6'] = prepare_csv_data(row[19], prefix='Capabilities')
            dict1['addl7'] = prepare_csv_data(row[20], prefix='Service Type')
