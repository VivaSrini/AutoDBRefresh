...
#     "State": "IL",
#     "Name": "Cook County, IL",
#     "Website": "https://cookcounty.diversitycompliance.com/FrontEnd/searchcertifieddirectory.asp",
#     "Title": "Certified Vendor Directory",
#     "Download": "Manual",
#     "FileName": "IL_COOK.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['website'] = prepare_csv_data(row[14])
            ...
            dict1['cert_start'] = prepare_csv_data(row[17])
            dict1['cert_expiry'] = prepare_csv_data(row[18])
            (pnaics, onaics) = get_pnaics_onaics(row[21])
            dict1['pnaics'] = pnaics
            ...
            dict1['addl6'] = prepare_csv_data(row[20], prefix='Service-Disabled Veteran Business?')
