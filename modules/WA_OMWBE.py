...
#     "Provider": "WA_OMWBE",
#     "State": "WA",
#     "Name": "Office of Minority and Women's Business Enterprises",
#     "Website": "https://omwbe.diversitycompliance.com/FrontEnd/SearchCertifiedDirectory.asp",
#     "Title": "Certified Vendor Directory",
#     "Download": "Manual",
#     "FileName": "WA_OMWBE.csv",
#   }
#
...
def processFile(filename):
    ...
    with open(filename) as f:
        ...
        for row_num, row in enumerate(reader):
            ...
            dict1['addl6'] = prepare_csv_data(row[19], prefix='UDBE')
            dict1['addl7'] = prepare_csv_data(row[20], prefix='SBE Certification')
            dict1['addl8'] = prepare_csv_data(row[21], prefix='UBI#')
